...
- cards có nội dung dài ngắn khác nhau nên nút mua không cùng vị trí với nhau được
...
- Container .hero mới chỉ khai báo display: flex; nhưng thiếu các thuộc tính căn chỉnh dọc và ngang cho items
